...
const DESCRIPTION =
  "Practice the Git and GitHub interview questions that actually come up — merge vs rebase, reset vs revert, branching strategy, pull requests, and CI — each with a complete, honest answer."
...
export default function InterviewQuestionsPage() {
  ...
  const jsonLd = useMemo(
    () => ({
      ...
      "@type": "FAQPage",
      name: "Git & GitHub Interview Questions",
  ...
  useSeo({
    title: "Git & GitHub Interview Questions & Answers",
